        ...
        private void loginButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_loginButtonActionPerformed
                ...
                if (authenticatedUser != null) {
                        ...
                        if (parent instanceof MainApplicationFrame) {
                                ...
                                if (authenticatedUser.getRole() == model.Role.INSURANCE_ADMIN) {
                                        // Insurance Admin role
                                        InsuranceProviderDashboard insuranceDashboard = new InsuranceProviderDashboard();
                                        mainFrame.addPanel(insuranceDashboard, "insuranceDashboard");
                                        mainFrame.showPanel("insuranceDashboard");

                                } else if (authenticatedUser.getRole().isAdminRole()) {
