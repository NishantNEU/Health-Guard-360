...
public class ManageEmployeesPanel extends javax.swing.JPanel {
    ...
    private void loadPersons() {
        ...
        for (model.User user : systemData.getUserDirectory().getAllUsers()) {
            ...
            if (user.getRole() != model.Role.PATIENT) {
                personComboBox.addItem(user.getUsername() + " - " + user.getPerson().getFirstName() + " " + user.getPerson().getLastName());
            }
        }
    }
    ...
    private void assignEmployee() {
        ...
        if (selectedEnterprise == null || selectedEnterprise.equals("-- Select Enterprise --")) {
            javax.swing.JOptionPane.showMessageDialog(this, "Please select an enterprise", "Validation Error", javax.swing.JOptionPane.ERROR_MESSAGE);
            return;
        }
        
        if (selectedOrganization == null || selectedOrganization.equals("-- Select Organization --")) {
            javax.swing.JOptionPane.showMessageDialog(this, "Please select an organization", "Validation Error", javax.swing.JOptionPane.ERROR_MESSAGE);
            return;
        }
        
        if (selectedPerson == null || selectedPerson.equals("-- Select Person --")) {
            javax.swing.JOptionPane.showMessageDialog(this, "Please select a person", "Validation Error", javax.swing.JOptionPane.ERROR_MESSAGE);
            return;
        }
        
        if (selectedRole == null) {
            javax.swing.JOptionPane.showMessageDialog(this, "Please select a role", "Validation Error", javax.swing.JOptionPane.ERROR_MESSAGE);
            return;
        }
        ...
        try {
            ...
            if (organization == null) {
                javax.swing.JOptionPane.showMessageDialog(this, "Organization not found", "Error", javax.swing.JOptionPane.ERROR_MESSAGE);
                return;
            }
            
            // Extract username from selected person (format: "username - FirstName LastName")
            ...
            model.Employee employee = new model.Employee(user.getPerson(), role, organization.getOrganizationId());
            
            // Add employee ID to organization
    ...
    private void initComponents() {
        ...
        organizationComboBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "-- Select Organization --" }));
        ...
        roleComboBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Manager", "Staff", "Doctor ", "Nurse", "Claims Processor", "Pharmacist" }));
        ...
        assignEmployeePanelLayout.setHorizontalGroup(
            ...
            .addGroup(assignEmployeePanelLayout.createSequentialGroup()
                .addGap(27, 27, 27)
                .addGroup(assignEmployeePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(assignEmployeePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(assignEmployeePanelLayout.createSequentialGroup()
                                .addGroup(assignEmployeePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(assignEmployeePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
        ...
        assignEmployeePanelLayout.setVerticalGroup(
            ...
            .addGroup(assignEmployeePanelLayout.createSequentialGroup()
                ...
                .addGroup(assignEmployeePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel4)
                    .addComponent(enterpriseComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(assignEmployeePanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(assignEmployeePanel, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(layout.createSequentialGroup()
                        .addGap(6, 6, 6)
